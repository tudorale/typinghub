...
function SignIn() {
  ...
  const seePassword = () => {
    ...
    let eyeClosed = document.querySelector(".eyeClosed") as HTMLElement;
    eyeClosed.style.display = "block";
    let eyeOpen = document.querySelector(".eyeOpen") as HTMLElement;
  ...
  return (
    <div className="signin">
      ...
      <form onSubmit={handleSignIn}>
        <div className="emailWrapperLogin">
        ...
        <div className="passwordWrapperLogin">
